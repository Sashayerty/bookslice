...
class User(SqlAlchemyBase):
    ...
    id = sqlalchemy.Column(sqlalchemy.Integer, primary_key=True, autoincrement=True) # noqa
    ...
    created_date = sqlalchemy.Column(sqlalchemy.DateTime, default=datetime.datetime.now, nullable=False) # noqa
